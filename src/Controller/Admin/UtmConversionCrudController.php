...
/**
 * UTM转化管理控制器
 * @extends AbstractCrudController<UtmConversion>
 */
#[AdminCrud(
    routePath: '/utm/conversion',
    routeName: 'utm_conversion',
)]
final class UtmConversionCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield AssociationField::new('session', 'UTM会话')
            ->setFormTypeOption('choice_label', function ($session) {
                if (!$session instanceof UtmSession) {
                    return 'N/A';
                }
